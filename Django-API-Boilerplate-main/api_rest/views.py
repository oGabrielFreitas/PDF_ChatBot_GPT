    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if request.GET['query']:
                ...
                # return Response('Entrou')

                url_query = request.GET['query'] # Get query from URL

                qa_resp = get_answer.Answer_Bot(url_query)

                # qa_resp = get_answer.qa_test()


                return Response(qa_resp)        
